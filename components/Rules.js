...
console.log(showGoldenCircle)
  return (
    <div className='h-[40vh] w-screen landscapes:h-[75vh] mt-5'>
        <div className='bg-white h-2/5 pt-4 mb-5 '> 
        ...
        <div className='bg-[url(/main_background.webp)] h-full bg-cover bg-no-repeat flex flex-row items-center pb-5'>
            <div className='w-3/5 pr-2 mt-5 pt-3'>
                <h2 className="font-['Cormorand_Garamond'] font-bold text-white pl-3 pb-2">POINTS</h2>
