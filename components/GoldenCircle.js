    ...
    <div className='bg-deep-blue w-screen flex'>
        ...
        <>
          <div className='w-3/5 pt-5 pl-3 pr-2'>
            ...
            <p className='text-xs text-gold italic pb-2'>Pour rejoindre le Cercle Doré <span className='text-xs text-gold font-bold italic'>envoyez-moi votre photo </span> de profil en MP.</p>
          </div>
          <div className='w-2/5 pt-5 flex flex-col justify-center items-center landscapes:pb-2 landscapes:pt-2'>
            ...
            <p className='text-white text-[8px] pt-1'>«Le cercle doré c'est fantastique.»</p>
